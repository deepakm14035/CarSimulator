...
class PixHawk_ThrottleControl {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PixHawk_ThrottleControl(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PixHawk_ThrottleControl(null);
...
module.exports = PixHawk_ThrottleControl;
