...
if("TRUE" STREQUAL "TRUE")
  set(e2o_SOURCE_PREFIX /home/deepak/catkin_ws/src/e2o)
  set(e2o_DEVEL_PREFIX /home/deepak/catkin_ws/devel)
  set(e2o_INSTALL_PREFIX "")
  set(e2o_PREFIX ${e2o_DEVEL_PREFIX})
else()
  set(e2o_SOURCE_PREFIX "")
  set(e2o_DEVEL_PREFIX "")
  set(e2o_INSTALL_PREFIX /home/deepak/catkin_ws/install)
...
if(NOT "/home/deepak/catkin_ws/src/e2o/include " STREQUAL " ")
  set(e2o_INCLUDE_DIRS "")
  set(_include_dirs "/home/deepak/catkin_ws/src/e2o/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'e2o' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/deepak/catkin_ws/src/e2o/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;rospy;std_msgs;message_runtime;can")
